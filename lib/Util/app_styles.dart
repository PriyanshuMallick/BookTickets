...
//
  ...
  static TextStyle headLineStyle4 = TextStyle(fontSize: 17, color: Colors.white, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle5 = TextStyle(fontSize: 14, color: textColor2, fontWeight: FontWeight.w500);
  static TextStyle headLineStyle5_1 = TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w500);
}
